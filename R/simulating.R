...
#' \code{c("normal", "ginkgo", "walnut", "3d_up", "3d_down", "3d_acer")}.
...
create_leaf <- function(type = c("normal", "ginkgo", "walnut", "3d_up", "3d_down", "3d_acer"), length_m = 0.01) {
  ...
  if (length(type) > 1 | !any(type %in% c("normal", "ginkgo", "walnut", "3d_up", "3d_down", "3d_acer"))) {
    stop("geom_type unknown")
  }
  ...
  if (type == "normal") {
    ...
    leaf_geom <- data.frame(
      "id" = c(rep(1:4, each = 4), rep(5:8, each = 5)),
      "x" = c(2,0,2.5,2,8,7.5,10,8,7.5,8,10,7.5,2.5,0,2,2.5,2,2.5,5,5.,2,5,5,7.5,8,5,7.5,5,5.,8,7.5,2.5,2,5,5,2.5),
      "y" = c(2.4,0,0,2.4,1.8,0,0,1.8,0,-1.8,0,0,0,0,-2.4,0,2.4,0,0,3,2.4,3,0,0,1.8,3,0,0,-3,-1.8,0,0,-2.4,-3,0,0.0),
      "z" = c(0.5,0,0.25,0.5,0.5,0.25,0,0.5,0.25,0.5,0,0.25,0.25,0,0.5,0.25,0.5,0.25,0.5,1,0.5,1,0.5,0.25,0.5,1,0.25,0.5,1,0.5,0.25,0.25,0.5,1,0.5,0.25))
  } else if (type == "3d_down") {
    # thanks to Nora for the polygon <3
    leaf_geom <- data.frame(
      "id" = c(rep(1:4, each = 4), rep(5:8, each = 5)),
      "x" = c(7.5,8,10,7.5,8,7.5,10,8,2.5,0,2,2.5,2,0,2.5,2,7.5,5,5,8,7.5,5,5,7.5,8,5,2,2.5,5,5,2,2.5,2,5,5,2.5),
      "y" = c(0.0,-1.8,0,0,1.8,0,0,1.8,0,0,-2.4,0,2.4,0,0,2.4,0,0,-3,-1.8,0,3,0,0,1.8,3,2.4,0,0,3,2.4,0,-2.4,-3,0,0),
      "z" = c(0.1,-0.5,0,0.1,-0.5,0.1,0,-0.5,0.4,0,-0.5,0.4,-0.5,0,0.4,-0.5,0.1,0.3,-1,-0.5,0.1,-1,0.3,0.1,-0.5,-1,-0.5,0.4,0.3,-1,-0.5,0.4,-0.5,-1,0.3,0.4))
  } else if (type == "3d_acer") {
    # thanks to Nora for the polygon <3
    leaf_geom <- data.frame(
      "id" = c(rep(1:6, each = 4), rep(7:12, each = 5)),
      "x" = c(1.25,0,-0.5,1.25,3.5,1.25,1.25,3.5,0,1.25,-0.5,0,5,7.25,5,5,5,5,7.25,5,1.25,3.5,1.25,1.25,1.25,1.25,0.75,-0.5,1.25,3.25,3.25,1.25,3.5,3.25,3.25,3.25,3.5,1.25,3.25,3.25,3.25,5,5,3.25,3.25,5,5,3.25,3.25,1.25,1.25,-0.5,0.75,1.25),
      "y" = c(0,0,2.5,0,4,0,3.5,4,0,0,-2.5,0,2.25,0,0,2.25,-2.25,0,0,-2.25,0,-4,-3.5,0,0,-3.5,-4,-2.5,0,2,0,0,4,2,0,-2,-4,0,0,-2,0,0,-2.25,-2,2,2.25,0,0,2,3.5,0,2.5,4,3.5),
      "z" = c(0.5,0,-0.5,0.5,-0.5,0.5,0,-0.5,0,0.5,-0.5,0,0,0,0.25,0,0,0.25,0,0,0.5,-0.5,0,0.5,0.5,0,0,-0.5,0.5,0,0.5,0.5,-0.5,0,0.5,0,-0.5,0.5,0.5,0,0.5,0.25,0,0,0,0,0.25,0.5,0,0,0.5,-0.5,0,0))
  }
